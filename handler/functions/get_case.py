...
def fn_get_case(location: str, data_helper: DataHelper, year: str = None):
    try:
        result = []
...
def fn_get_total_case_year(location: str, year: int, data_helper: DataHelper):
...
def fn_get_case_continent(location: str, data_helper: DataHelper, year):
    result = {}
